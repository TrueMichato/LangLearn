# Plain Present Form (Dictionary Form)

> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/verb-plain-present-form/). For personal study.
...
The plain present is the basic form of Japanese verbs usually listed in the dictionary (Hence, it's also known as "the dictionary form"). Verbs in this form end with the "u" sound as in or *nom**u***, *tuka**u***, or *sur**u***, though they are classified in three different conjugation groups.
...
<!-- quiz: {"type":"multiple-choice","question":"What does \"兄は毎日パスタを**食べる**。\" mean?","options":["My brother **eats** pasta everyday.","My brother **will eat** pasta tomorrow.","I **throw** a party **every year.**","Want some?"],"answer":0} -->
