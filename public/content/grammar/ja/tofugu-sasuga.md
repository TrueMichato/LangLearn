...
> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/sasuga/). For personal study.

さすが: Japanese Word for Compliments and Contradictions
- 
...
Did you notice that な was added before だけある? For nouns and な-adjectives, you have to add な, giving you **な**だけある.
...
Feel like you got the gist of the word さすが now? Here's some bonus material — a two-part podcast series about さすが to take it to the next level and get a complimentary さすが from your sensei. In this episode, we discuss more real-life examples, so make sure to give it a listen!

Tofugu · さすが Miniseries
...
モダリティを表す副詞の類義性と多義性－「やはり」、「さすが」、「しょせん」を中心に－
...
<!-- quiz: {"type":"multiple-choice","question":"What does \"A5和牛は、さすがに美味しい。\" mean?","options":["It's only natural that A5-grade wagyu is delicious.","Despite being A5-grade wagyu, it's inevitable that it's not delicious.","No wonder!","Your shot's impressive, Mr. Suzuki."],"answer":0} -->
...
- [Tofugu](https://www.tofugu.com/japanese-grammar/sasuga/)
