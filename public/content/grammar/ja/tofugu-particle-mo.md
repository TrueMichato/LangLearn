...
> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/particle-mo/). For personal study.

Particle も:  Addition Marker
- 
...
By marking 私 with も, this person also adds themselves to the group of "people who are Japanese teachers."
...
On the other hand, the particle も is only attached to the word that you want to add on to the list. So, if you say 鈴木さん**も**, it is clear that 鈴木さん is a new member *in addition to someone else*.
...
In this sentence, も attaches to 今日 and adds the nuance of "in addition to yesterday." Now, both yesterday and today are in the set of "days it rained.” Maybe we'll have to add 明日**も** (tomorrow, also) if the rain persists.
...
In this example, と groups together "Mori-san and Yamada-san" and then も marks the two of them as an addition to the set, as in [森さん**と**山田さん]**も**.
...
(1989)
pp. 5, 17, 29, 46, 97-100, 247-253, 255-257, 354, 393, 468-473
...
<!-- quiz: {"type":"multiple-choice","question":"What does \"鈴木さん**も**日本語の先生です。\" mean?","options":["Suzuki-san is **also** a Japanese teacher.","I **also** teach Japanese.","Suzuki-san is a teacher. Suzuki-san **is also a gamer**.","I cannot do **this, either**."],"answer":0} -->
