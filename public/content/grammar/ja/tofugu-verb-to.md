...
> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/verb-to/). For personal study.

Japanese Verb と Form
- 
...
In Japanese, the particle と wears a lot of hats. The one you may be the most familiar is と as in "X **と** Y" (X **and** Y), for example. However, on this page, we'll introduce the と that shows a strong causal relationship.
...
Let's try applying this to the "**When** X happens, the result is always Y" equation using an example:
  ...
  - If you eat bacon without her permission, Mami always gets upset.
   ...
   If you eat bacon without her permission
...
<!-- quiz: {"type":"multiple-choice","question":"What does \"勝手にベーコンを食べると、マミは怒る。\" mean?","options":["If you eat bacon without her permission, Mami always gets upset.","When I drink alcohol, I always crave for sweets (without exception).","When it is sunny, I usually go for a run.","When it was sunny, I usually went for a run."],"answer":0} -->
