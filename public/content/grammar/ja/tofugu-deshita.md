# でした (deshita) — Past Copula (Polite)

> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/deshita/). For personal study.

でした: Polite Japanese Word for the Past
- 
...
でした is a past tense marker for nouns and な-adjectives. It tells us that the word it’s attached to is relevant to the past, kind of like the word “was” in English. So,「先生**でした**」means “**was** a teacher”, and「**大変**でした」means “**was** terrible”. でした is associated with the polite form, just like です.
...
When でした appears in the middle of a sentence, it means that there are actually *two* or more clauses within that sentence. A clause is essentially a sentence that exists inside or connected to another sentence. でした can appear in the middle of a sentence if there are two independent clauses that are joined together into one sentence:
  ...
  - [A: 誕生日**でした**]–から–[B: ハムスターはケーキを食べるべき**でした**]。
...
Because clause A and clause B would become independent sentences if から was removed, it is possible for both clauses to have different politeness levels. In the example above, they are the same; both marked as polite by でした at the end of each clause. However, it would be grammatical to change the ending of clause A to the plain form using だった, and then mark clause B as polite with でした:
  ...
  - [A: 誕生日**だった**]–から–[B: ハムスターはケーキを食べるべき**でした**]。
...
Even though clause A is marked with だった, this sentence feels polite overall, because the ending of the *entire* sentence is the most potent marker of politeness. While we can have clause A in the plain form and clause B in the polite form, the reverse is not possible:
  ...
  - ❌[A: 誕生日**でした**]–から–[B: ハムスターはケーキを食べるべき**だった**]。
...
ハムスター (はむすたー) — hamster (noun)

誕生日 (たんじょうび) — birthday (noun)

会 (かい) — party (noun)

素敵 (すてき) — wonderful (な-adjective)

食べませんでした (たべませんでした) — did not eat (ichidan verb / polite negative form / past tense)
...
何日 (なんにち) — what day (question word)
...
by Hideki Chosa and Hiroyuki Shirakawa
(2016)

- 
[Paper]

The Pastness of Modal Ta in Japanese

by 定延 利之
(2004)

<!-- quiz: {"type":"multiple-choice","question":"What does \"昨日はペットのハムスターの**誕生日**でした。\" mean?","options":["Yesterday was my hamster’s birthday.","The hamster’s birthday party was wonderful.","The hamster did not eat cake.","Because it was her birthday, the hamster should have eaten cake."],"answer":0} -->
