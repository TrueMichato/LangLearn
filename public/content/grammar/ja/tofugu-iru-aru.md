# いる vs ある — Existence Verbs

> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/iru-aru/). For personal study.

いる and ある: Japanese Verbs "To Exist" or "There Is"
- 
...
If you replace うち with  家(いえ), which only indicates the physical house, ある begins to sound strange.

  - ⭕  家(いえ)には今お客さんが**いる**んです。

❌  家(いえ)には今お客さんが**ある**んです。
...
「～が　ある」の用法 一（あわせて）「人がある」と「人がいる」の違い一

by Taro Takahashi and Shigeko Yahisa
(1984)
...
by Sung-Yeo Chung and Naohiko Kurokawa
(2012)

<!-- quiz: {"type":"multiple-choice","question":"What does \"犬が**いる**。\" mean?","options":["There is a dog.","There is a mountain.","There are fish in the river.","There is a lawyer and a client in the office."],"answer":0} -->
...
- [Tofugu](https://www.tofugu.com/japanese-grammar/iru-aru/)
