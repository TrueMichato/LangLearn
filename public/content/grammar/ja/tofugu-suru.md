...
> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/suru/). For personal study.
...
As said in the beginning, する has a number of uses that are akin to the English "to do."
The most prevalent ones are everyday tasks, such as 洗い物をする (to do the dishes) or 洗濯をする (to do the laundry). Here is a list of some examples, with some nonstandard translations given in parentheses.

  
      買い物をする
      to shop (to do some shopping)
...
Here are some examples:
      ...
      お茶をする
      to have tea, to have a tea break
...
by Hideki Kishimoto and Satoshi Uehara
(2016)
pp. 425-458
...
by Atsuko Shimada and Valia Kordoni
(2003)
...
(1990)
pp. 39, 20-26, 204, 310-311, 360, 428-439
...
<!-- quiz: {"type":"multiple-choice","question":"What does \"私が**する**よ。\" mean?","options":["I'll **do** it.","to **do** homework","to put on a necklace","to do homework"],"answer":0} -->
...
- [Tofugu](https://www.tofugu.com/japanese-grammar/suru/)
