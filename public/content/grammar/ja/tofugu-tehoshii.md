...
> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/tehoshii/). For personal study.

〜てほしい To Express What You Want Someone To Do
- 
...
To express desire for something, we use ほしい in Japanese. So if you want a  掃除機(そうじき) (vacuum cleaner), you can say 掃除機がほしい to mean "I want a vacuum cleaner."
...
For example, the negative form of 言う is 言わ**ない** and by adding 〜でほしい, you can say:
...
The causative 〜させる form indicates that someone is forcing or allowing someone else to do the action, depending on context. So if you say 娘を留学**させる**, it means you force or permit your daughter to study abroad.
...
Although the above sentence sounds polite thanks to all the additional elements, 〜てほしい is still a direct way to convey what you want. You can use it if you and the senior employee are on friendly terms, but if you want to sound more appreciative, you can switch it to the similar expression 〜てもらいたい, as in:
  ...
  - この資料を確認し**てもらいたい**んですが、お願いしてもいいですか？
...
You may see that the particle に marks 雨 or 雪 in a sentence like 雨／雪になってほしい, but this use of に is marking the result of a change of state and it's not the subject of the sentence. In fact, there will be an omitted subject here, like 天気**が**雨／雪**に**なってほしい (I want the weather to be rainy/snowy). ↩
...
- 
[Article]
A Psychological Approach to the Japanese Particles ga, ni, and o
by George Takahashi
(1968)

<!-- quiz: {"type":"multiple-choice","question":"What does \"掃除機をかけてほしい。\" mean?","options":["I want (my roommate) to vacuum.","I want (the update) to end quickly.","I want my roommate to vacuum.","I want my roommate to vacuum too."],"answer":0} -->
