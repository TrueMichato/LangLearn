...
> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/mada/). For personal study.

まだ for "Still / Not...Yet"
- 
...
Note that the い-adjective 冷たい (meaning "cold" for things) takes the negative くない form in the second example. 1

In the case of a な-adjective, you would attach じゃない to the end. Take the な-adjective  有名(ゆうめい) (meaning "famous"):
...
Of course, you can use まだ withです or だ, too, as in **まだ**先生です or **まだ**先生だ.
...
And again, you can use まだ with different variations, too, such as **まだ**先生[じゃないです・ではない・ではありません].
...
This is a bit tricky because the English translation doesn't usually include the word "not" unless you want to express your surprise that dinner isn't ready yet. In Japanese, the complete statement would be, 晩ごはんまだ**できてない**？ (Is the dinner not ready yet?).
...
Here, the full sentence would be まだ**できてない**よ. In its shortened form, できてない is replaced with だ.
...
For example, you may respond with まだ (not yet) when your mom asks if you finished your homework.
  ...
  - You have**n't** finished your homework **yet**?
...
But depending on the context, まだ in this instance can also imply "not yet." The identical dialogue, for instance, can be rephrased as follows:
  ...
  - I have**n't** broken up with that guy **yet**.
...
For instance, if you force yourself to study kanji for two hours every day, you might start to get tired of it toward the end of your study session. **まだ**十五分もある in this context conveys the unfavorable implication that although you want to be done soon, you still have 15 minutes left to go.
...
However, again, this sentence can also imply that you're talking about something negative that you don't want to remain the case. For example, if you're discussing your homework instead of your medication, you can say **まだ**十日分くらい残ってる in a tone that conveys your frustration.
...
When まだ means "still," it can indicate the continuation of something that started in the past, as in **まだ**雨が降っている (it's **still** raining), but it can also be used to talk about something currently happening that will continue in the future. For instance, if it's raining and you think it will keep raining for a while, you can use まだ and say:
...
Let's consider another scenario. Someone asks you, "Would you rather have nosy neighbors or noisy neighbors?" Of course, neither sort of neighbor is desirable, but you might find that the nosy ones are slightly more tolerable than the ones who constantly make noise, so you say:
  ...
  - うるさい人より、人のことを知りたがる人の方が**まだ**ましかな。
...
<!-- quiz: {"type":"multiple-choice","question":"What does \"**まだ**食べる！\" mean?","options":["I'm **still** gonna eat (it)!","Are you going to finish this or not?","I'm **still** eating.","I have**n't** eaten **yet**."],"answer":0} -->

<!-- quiz: {"type":"multiple-choice","question":"What does \"**まだ**食べ**ない**の？\" mean?","options":["Are you going to finish this or not?","I'm **still** gonna eat (it)!","I'm **still** eating.","I have**n't** eaten **yet**."],"answer":0} -->

<!-- quiz: {"type":"multiple-choice","question":"What does \"**まだ**食べて(い)る。\" mean?","options":["I'm **still** eating.","I'm **still** gonna eat (it)!","Are you going to finish this or not?","I have**n't** eaten **yet**."],"answer":0} -->

## Sources

- [Tofugu](https://www.tofugu.com/japanese-grammar/mada/)
