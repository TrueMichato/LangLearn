...
> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/temiru/). For personal study.
...
With the helping verb 見る (to see), a verb in the てみる form implies trying to do something to *see* what it's like or what will happen. 1
...
To suggest something more politely, however, you would add どう as well as the polite marker です with the particle か:
...
Lastly, 思ってもみなかった is an idiomatic expression with the meaning "this was utterly unexpected." This expression is typically used after a specific situation has arisen and it was far beyond your expectation.
  ...
  - でも、やる前はこんなに簡単だって**思ってもみなかった**んだよ。
...
<!-- quiz: {"type":"multiple-choice","question":"What does \"食べ**てみる**よ。\" mean?","options":["I'll try it.","I want to try that too!","I want to go to Mars someday.","Alright, I'll open it and see what's inside."],"answer":0} -->
...
- [Tofugu](https://www.tofugu.com/japanese-grammar/temiru/)
