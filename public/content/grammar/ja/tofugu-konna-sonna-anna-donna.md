...
> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/konna-sonna-anna-donna/). For personal study.

Japanese Demonstratives: こんな(Konna) • そんな(Sonna) • あんな(Anna) • どんな(Donna)
- 
...
こんな, そんな, あんな, and どんな are casual expressions. In more formal settings, such as in an official speech or for formal writing, you'll use この 様(よう)な, その 様(よう)な, あの 様(よう)な, and どの 様(よう)な instead.
...
These words can also go before the particle に​​, which emphasizes the extent of the adjective or quantity. We'll talk more about this usage later.
...
Imagine you meet an alien and the next day you tell your friend about it.
  ...
  - 昨日宇宙人に会ったんだよ。いやー、まさか[**こんな**・**そんな**・**あんな**]体験をする日がくるとは…。
...
〜 風(ふう) is another word for "way" or "manner," and it's commonly used with names of people and locations, like ブラッド・ピット風 (Brad Pitt style) or イタリア風 (Italian style). As you can see, 〜風 describes an approximate way or manner rather than a precise one.
...
Other words like 〜風 include 〜 感(かん)じ (feeling) and 〜 様(よう) (manner), and they are used in the same way. Here, 〜感じ is very casual and 〜様 is very formal, while 〜風 is neutral. 2
...
The particle に of こんなに, そんなに, and あんなに can be omitted in some dialects or in very casual conversation. ↩

    

    - 
      
〜風 and 〜様 work as な-adjectives, while 〜感じ works as a noun. ↩
...
Functional Structure(s), Form and Interpretation: Perspectives from East Asian Languages (Routledge Studies in Asian Linguistics)

by Andrew Simpson and Audrey-Li Yen-hui
(2003)
pp. 97-128
...
by David Y. Oshima and Eric McCready
(2017)

- 
[Article]

Psycholinguistic Research on Japanese Demonstratives KO/SO/A
...
A revisit to the differences between kono and sono in the anaphoric usage
...
Differences between Ko and So in anaphoric usages
...
by Tarō Takahashi and Mitsuyo Suzuki
(1989)
...
ことばの疑問: 指示詞「これ」「それ」「あれ」は，どんなふうに使い分けられていますか
...
<!-- quiz: {"type":"multiple-choice","question":"What does \"**こんな**本がほしかったんだ。\" mean?","options":["I wanted **this kind of** book!","Where did you buy an interesting book **like that**?","I've never seen **something like that over there**.","I wonder if they are okay eating **that much**."],"answer":0} -->
...
- [Tofugu](https://www.tofugu.com/japanese-grammar/konna-sonna-anna-donna/)
