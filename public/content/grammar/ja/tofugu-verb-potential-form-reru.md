...
> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/verb-potential-form-reru/). For personal study.

Japanese Verb Potential れる Form
- 
...
〜れる is what we're calling the **potential form**. This verb suffix expresses the ability or possibility to do the action described by the verb, as in 食べられる (can eat), 飲める (can drink), and 泳げる (can swim). As you can see, the potential form is similar to the word "can," but it is built into the Japanese verb rather than a separate word like in English.

### Conjugating Verbs to Take 〜れる

To begin, let's examine how 〜れる is added to a verb. Depending on the verb's conjugation group, 〜れる might actually take a different form. In fact, the structure of this form is currently undergoing changes in Japanese, so be sure to check that out.
...
For godan verbs, replace the ending vowel from the う column on the kana chart to its corresponding え column kana and add る. So if the original ending is 〜う, the new ending will be 〜える. If it's む, your new potential ending will be 〜める, and so on.

Let's try conjugating the verb 買う (to buy) into its potential form (because it's such a good feeling when you're able to buy something). 買う (ka**u**) becomes 買える (ka**eru**).
...
Let's take a look at another example. What about 読む (to read)? You would want to conjugate 読む (yom**u**) into 読める (yom**eru**).
...
However, this 〜られる ending is actually completely identical in structure to the passive form! For this reason, the Japanese languages has shifted and it's become common to omit the ら part of the ending. Many kids these days (and even those who are not so young) say 食べ**れる** instead of 食べ**られる**. This phenomenon is called ら抜き言葉, literally meaning "taking ら off words." While the usage of ら抜き has been controversial, the trend is becoming more of a new standard.

#### Irregular Verbs

As for irregular verbs, the potential form of  来(く)る (to come) is  来(こ)られる. As you might have guessed from the られる ending, you will see people using ら抜き言葉 form,  来(こ)れる, quite often.

する (to do) becomes a totally-different-looking verb—できる.
...
Maybe your classmate is just being crazy, or maybe it is a special type of eraser you can eat! In any case, you can say that it's edible using the potential form of 食べる (to eat)—食べ**られる**.
...
However, in Japanese, the potential form is not used for asking for a permission so if you said, トイレに行ける？, it would literally mean, "Am I able to go to the bathroom?," or "Are you able to go to the bathroom?" Clearly not what you mean to say, right?
...
In general, 〜てもいい is used for this kind of situation instead of the potential form. This is similar to saying, "Is it okay if…?" in English. Yay! Now take that sip — you must be thirsty by now!
...
by Wasabi – Learn Japanese Online
(2016)

- 
[Paper]

日本語の無意志自動詞について ―可能という観点から―

by 呂 雷寧
(2010)

<!-- quiz: {"type":"multiple-choice","question":"What does \"日本語が**読める**。\" mean?","options":["I **can read** Japanese.","I **can read** small letters from afar.","You **can read** books by Haruki Murakami at that coffee shop.","In Japan, you **can drink** alcohol in parks."],"answer":0} -->

<!-- quiz: {"type":"multiple-choice","question":"What does \"遠くからでも小さい文字が**読める**。\" mean?","options":["I **can read** small letters from afar.","I **can read** Japanese.","You **can read** books by Haruki Murakami at that coffee shop.","In Japan, you **can drink** alcohol in parks."],"answer":0} -->

<!-- quiz: {"type":"multiple-choice","question":"What does \"そのカフェでは村上春樹の本が**読める**。\" mean?","options":["You **can read** books by Haruki Murakami at that coffee shop.","I **can read** Japanese.","I **can read** small letters from afar.","In Japan, you **can drink** alcohol in parks."],"answer":0} -->
