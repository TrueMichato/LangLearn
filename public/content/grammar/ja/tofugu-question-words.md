# Question Words (誰, 何, どこ, etc.)

> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/question-words/). For personal study.
...
A question adverb usually appears somewhere before the word it modifies in a sentence.
For example, you can place it at the very beginning of a sentence:
...
This is a way of putting emphasis on the rest of the sentence. When would you use a question like this? Perhaps you wanted to know the reason the earth is blue, but the person who's answering has started talking about why the ocean is blue instead. In this case, you can emphasize that you're asking why *the earth is blue*, not why *the ocean is blue*. When a question adverb is at the end of a sentence, it can be followed by だ・です, or their variants.
...
どちら is the question word version of こちら, そちら, and あちら. Although どちら is similar to どっち, it is often used as an indirect way of asking about directions, things, people and more. It can also be used for questions covering more than two options. Because of the indirectness, the word carries a very polite feel.
  ...
  - 生ビールと瓶ビールと缶ビールがございますが、**どちら**がよろしいですか？
...
As long as the speech style of the rest of the sentence is polite, it wouldn't necessarily sound informal, but there's another way to say "which 〜" with a more polite feel. That is, どちらの〜, which is どちら with the particle の attached. While どの can be used to ask "which" out of many options, どちらの is usually used for when you have only two options.
...
When it's used as an adverb, particles to mark いつ are not required, even though you usually mark time with the particle に or sometimes で, as in 八月**に**東京に行きます (I'm going to Tokyo in August).
...
どちらか
    ...
    いつか
    sometime, one day (past or future)
...
どちらも
    ...
    every one of them, both of them
...
This  何(なに)〜 prefix usually works with word variants that have a common ending. 県 is used to end the names of most prefectures, like 千葉県 or 秋田県, so 何県 is usable there. On the other hand, if you're trying to ask about something that doesn't have a common ending, you can use the question determiner どの. For example, country names in Japanese are a bit of a mixed bag. Some end in 国 (country), such as 中国 (China) or 韓国 (Korea). But there are plenty of countries that don't use 国 at the end, like イタリア (Italy) or トルコ (Turkey). So when asking "what country," it's more natural to use どの国 instead of 何国.
...
いくらも〜ない is an old-fashioned expression. ほとんど〜ない is more commonly used these days. ↩
...
by niwa saburoo の日本語文法概説
(2019)

<!-- quiz: {"type":"multiple-choice","question":"What does \"**レストラン**に行きましたか？\" mean?","options":["Did you go to **a restaurant**?","Did you give **Kenichi** **a present**?","Out of all foods, **which one** is your most favorite?","We have draft beer, bottled beer, and canned beer. **Which one** would you prefer?"],"answer":0} -->
...
- [Tofugu](https://www.tofugu.com/japanese-grammar/question-words/)
