...
> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/particle-yori-than/). For personal study.
...
Another common pattern with より is 〜方が〜より〜 (or より**も**, sometimes), like:

  - トム**の方が**、ベン**よりも**背が高い。

  - Tom is taller than Ben.

方 is a word that can be used to indicate a particular "direction." When it's used in a comparison, 方 indicates you're comparing two entities and pointing to one of them. In this case, 方 shows you're pointing in the direction of Tom and marks him as the subject of the comparison. Since 方 behaves like a noun here, it takes the particle の to follow another noun トム, as in トム**の**方.
...
Of course, な-adjectives like  真面目(まじめ) need a な when you attach them to 方. This is because 方 works like noun — remember? より, on the other hand, is a particle and not a noun, so it can attach to な-adjectives without using a な.

  - 真面目**な方が**、 不真面目(ふまじめ)**より**いい。
...
When comparing two entities, you might want to include information to talk about *how much* the entities differ by. In this case, that information is normally placed just after より or よりも. For example, if you want to say "Tom is *three years* older than Ben," the word ３才 (three years) comes after よりも, as in:
...
### 〜より仕方がない・〜より仕様がない・〜より他ない

When より is used with  仕方(しかた)がない /  仕様(しよう)がない (no other way) or  他(ほか)ない (no other option), it means "there is no other choice than to…"
