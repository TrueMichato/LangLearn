...
> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/verb-nagara/). For personal study.

Japanese Verb ながら to Say "While〜"
- 
...
<!-- quiz: {"type":"multiple-choice","question":"What does \"食べながら**遊ぶ**\" mean?","options":["While eating, **play**","While having lunch, let's talk sometime.","Let's talk while having lunch sometime.","Let's eat while talking sometime."],"answer":0} -->

<!-- quiz: {"type":"multiple-choice","question":"What does \"今度、お昼を食べながら話しましょう。\" mean?","options":["While having lunch, let's talk sometime.","While eating, **play**","Let's talk while having lunch sometime.","Let's eat while talking sometime."],"answer":0} -->
