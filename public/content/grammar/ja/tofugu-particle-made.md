...
> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/particle-made/). For personal study.

Particle まで: Endpoint Marker
- 
...
When some things are aligned in a standard order, and each item has a number or name, the start and end points can also be marked by から and まで. Here's a couple of examples.
  ...
  - この曲は１番**から**３番**まで**あります。

  - This song has verse 1 **to** verse 3.

  - アルファベットはA**から**Z**まで**です。
...
まで doesn't have that function because it can only mark the "end point." So saying 納豆１０パック**まで** suggests ten packs of natto are the farthest item in the list of the things you ate. So the above sentence with まで means either you'd eaten something else beforehand and then "you even ate ten packs of natto," or you've entered a natto eating competition, and so far, you've eaten up to ten packs of natto.
...
(2002)
pp. 25, 50-52, 57-59, 80-81, 161, 168

<!-- quiz: {"type":"multiple-choice","question":"What does \"家**から**学校**まで**の距離は１kmです。\" mean?","options":["The distance between my house and school is 1km.","I'll walk **from** my house **to** school.","I'll walk **to** school.","Wait **until** I eat this!"],"answer":0} -->
