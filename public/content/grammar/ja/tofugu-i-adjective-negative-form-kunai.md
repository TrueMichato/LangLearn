...
> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/i-adjective-negative-form-kunai/). For personal study.

Japanese い-Adjective Negative Form くない
- 
...
〜くない is the negative form of い-adjectives. So while 難し**い** means "**is**-difficult," 難し**くない** means "**is-not**-difficult." Notice that both of these end in the present tense 〜い ending, a feature that they both share.
...
<!-- quiz: {"type":"multiple-choice","question":"What does \"難しく**ないです**\" mean?","options":["is not difficult (formal)","That comedian **is not funny**.","A **not-funny comedian** made **not-bitter coffee**.","not delicious (but…)"],"answer":0} -->
