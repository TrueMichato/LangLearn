...
> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/desu/). For personal study.

です: Japanese Word for Politeness
- 
...
The most fundamental function of です is to mark a sentence as polite. You might be tempted to think of it as the polite form of だ, but these two words have some pretty big differences. Put simply, だ marks sentences as present tense and positive, whereas です is really just a simple marker of politeness.
...
納豆 (なっとう) — natto, fermented soy beans (noun)

健康的 (けんこうてき) — healthy (な-adjective)

まずい (まずい) — unpleasant, unappetizing (い-adjective)

トマト (とまと) — tomato (noun)

野菜 (やさい) — vegetable (noun)

新鮮 (しんせん) — fresh (な-adjective)

私達 (わたしたち) — we, us (personal noun)

食べない (たべない) — not eat (ichidan verb / negative form / non-past tense)

昨日 (きのう) — yesterday (noun)

美味しかった (おいしかった) — was delicious (い-adjective / past tesne)

前 (まえ) — previous, before (noun)

日 (ひ) — day (noun)

元気 (げんき) — healthy, genki (な-adjective)

世界中 (せかいじゅう) — around the world (noun)

皆さん (みなさん) — everyone (noun)

伝えたい (つたえたい) — want to tell (ichidan verb / desiderative 〜たい form / non-past tense)

言いました (いいました) — said (godan verb / past tesne)

健康 (けんこう) — health (な-adjective)

第一 (だいいち) — number one (noun)
...
The Japanese Copula Revisited: Is da a Copula?
...
<!-- quiz: {"type":"multiple-choice","question":"What does \"私は萌子**です**。\" mean?","options":["I am Moeko.","Ok, here’s the natto.","Natto is healthy.","Natto is unpleasant."],"answer":0} -->

<!-- quiz: {"type":"multiple-choice","question":"What does \"はい、**納豆**です。\" mean?","options":["Ok, here’s the natto.","I am Moeko.","Natto is healthy.","Natto is unpleasant."],"answer":0} -->

<!-- quiz: {"type":"multiple-choice","question":"What does \"納豆は**健康的**です。\" mean?","options":["Natto is healthy.","I am Moeko.","Ok, here’s the natto.","Natto is unpleasant."],"answer":0} -->
