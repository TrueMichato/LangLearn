...
> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/conjunctive-particle-noni/). For personal study.

Conjunctive Particle のに: For Expressing Surprise / Frustration
- 
...
<!-- quiz: {"type":"multiple-choice","question":"What does \"クーラーをつけたのに、全然涼しくならなかった。\" mean?","options":["I turned on the AC, but it wasn't getting any cooler.","[I turned on the AC] but [it wasn't getting any cooler].","[It's a lemon] but [it's very sweet].","[It's quiet] but [I can't sleep]."],"answer":0} -->
