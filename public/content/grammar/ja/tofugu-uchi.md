...
> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/uchi/). For personal study.

うち: Japanese Word For "Inside"
- 
...
うち is a word that means “inside,” as opposed to “outside.” When it’s used with other grammar elements, like 〜のうち or 〜のうちに, it indicates the inside of a certain range.
...
うち can also follow verbs. When it indicates a time period, it's common to attach to いる, the 〜ている form, 〜れる form, and 〜ない form of a verb.
...
You can make various patterns using numbers with counters. For example, to say "two out of three people," you can use the counter 人 and say:
...
You may also see this use of うち with other particles, such as the subject marker が and the topic marker は. For example, the followings are common phrases:
...
As you've seen, うち can be preceded by different types of words. One last note is that the clause that comes before うち usually has to be non-past tense, even if the main clause is in the past tense.
  ...
  - ⭕寝てい**る**うちに、iPhoneを盗まれ**た**。

 ❌寝てい**た**うちに、iPhoneを盗まれ**た**。
...
<!-- quiz: {"type":"multiple-choice","question":"What does \"３つのタマゴのうち１つ割れていた。\" mean?","options":["Out of three eggs, one was broken.","By the end of this year, I'll make some Japanese friends!","one of the two things","I finished my homework by the end of the summer vacation."],"answer":0} -->
...
- [Tofugu](https://www.tofugu.com/japanese-grammar/uchi/)
