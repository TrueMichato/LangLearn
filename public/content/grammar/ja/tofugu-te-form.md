...
> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/te-form/). For personal study.
...
For godan verbs that end in **う**, **つ**, or **る**, replace the ending sounds with **って**. For example, the て form of 会う (to meet) is:
...
As usual,  来(く)る (to come) and する (to do) conjugate irregularly. In the て form, they become:
...
We can also do this with more than two words, and you can freely combine different word types together to your heart's content. Just remember that all words other than the last one will be in the て form:
  ...
  - ここは料理の鉄人のお店**で**、静か**で**広**くて**人気が**あって**、おいしい。
...
<!-- quiz: {"type":"multiple-choice","question":"What does \"走っ**て**シャワーをする。\" mean?","options":["I run **and** shower .","I go to the station **by** running.","That restaurant is spacious **and** quiet.","That restaurant is quiet **and** spacious."],"answer":0} -->

<!-- quiz: {"type":"multiple-choice","question":"What does \"走っ**て**駅に行く。\" mean?","options":["I go to the station **by** running.","I run **and** shower .","That restaurant is spacious **and** quiet.","That restaurant is quiet **and** spacious."],"answer":0} -->
...
- [Tofugu](https://www.tofugu.com/japanese-grammar/te-form/)
