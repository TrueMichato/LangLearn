# じゃない / ではない — Negative Copula

> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/janai-dewanai/). For personal study.
...
Adding 〜じゃない or 〜ではない to the end of a noun or a な-adjective makes it negative, similar to the way "not" functions in English. Between the two, 〜じゃない is more casual, whereas 〜ではない is formal.
...
It pretty much comes down to the level of formality. 
Let's break it down.
...
You might know the past tense of です is でした, but be warned. You can not turn 〜[じゃ・では]ない**です** into 〜[じゃ・では]ない**でした**.

To form the past tense, you instead conjugate ない, as in 〜[じゃ・では]**なかった**です.
...
On the contrary, none of the elements in 〜ではありません can further conjugate to indicate the past tense. Therefore, you actually *need* でした to talk about the past here, as in 〜ではありません**でした**.
...
〜じゃない can be used for purposes other than negation, too. Check out this example! 2
  ...
  - Is this alcohol?
(*Literally*: It is alcohol, **isn't it?**)
...
Finally, notice that the subject 私 (I) is omitted in Japanese? This is because in Japanese subjects or objects tend to be omitted when they're clear from the context. So keep in mind that depening on the context, this exact same sentence, それ、お酒だって言った**じゃない** can mean, "Hey, you said it was alcohol!," with the same implication of "I'm not letting you agree that it isn't the case."
Footnotes:
...
In this usage, it's possible to prolong the pronunciation of じゃ, as in それはお酒じゃーない. In this case, the pitch accent of (↓↑↑↓↑↓↑).  "おさけじゃぁない。  / It isn't alcohol." ↩

    

    - 
      
Grammatically, this use of じゃない is called a "tag question." ↩
...
by Seiichi Makino, Michio Tsutsui, Seiichi Makino and Michio Tsutsui
(1995)
pp. 30-33
...
終助詞類のアクセントとイントネーション : 「よ」 「か」「の」「な」「でしょ（う）」「じゃない」、 とびはね音調の「ない」

by Kori Shiro
(2018)

<!-- quiz: {"type":"multiple-choice","question":"What does \"ネコ[**じゃない**・**ではない**]。\" mean?","options":["It **isn't** a cat.","It **isn't** weird.","It **wasn't** a cat.","It **wasn't** weird."],"answer":0} -->

<!-- quiz: {"type":"multiple-choice","question":"What does \"変[**じゃない**・**ではない**]。\" mean?","options":["It **isn't** weird.","It **isn't** a cat.","It **wasn't** a cat.","It **wasn't** weird."],"answer":0} -->
