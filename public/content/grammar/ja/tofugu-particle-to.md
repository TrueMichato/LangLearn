...
> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/particle-to/). For personal study.

Particle と: For Connecting Words Together
- 
...
In this example, と marks  妹(いもうと) (little sister) as the person accompanying you on your tomato eating adventure.
...
In this case, the と between 妹 and  弟(おとうと) (little brother) works like "and," connecting the two of them together. The と after 弟 works like "with," marking your 妹 and 弟 as the people who ate the tomatoes with you.

What if you ate more foods with more people? Well, you simply connect everyone together using と.

  - 妹**と**弟**と**お父さん**と**お母さん**と**トマト**と**バナナ**と**ケーキ**と**ラーメン**と**すしを食べた。
...
For example, to list beverage options and ask "which one would you like?" you can connect the options with と and ask:
  ...
  - 牛乳**と**ジュース**と**紅茶**と**コーヒー(**と**)、どれがいいですか？
...
Clause-Chaining, Switch-Reference and Action/Event Continuity in Japanese Discourse: The Case of Te, To and Zero-Conjunction
...
<!-- quiz: {"type":"multiple-choice","question":"What does \"ペン太**と**ペン子は友達だ。\" mean?","options":["Penta and Penko are friends.","I'm going to eat tomatoes and bananas.","I'm going to eat tomatoes, bananas, cake, ramen and sushi.","I ate tomatoes with my little sister."],"answer":0} -->
