...
> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/conjunctive-particle-node/). For personal study.

Conjunctive Particle ので: For Expressing a Reason
- 
...
You may be wondering, "why do we add な?" This is because な historically comes from だ, which marks nouns and な-adjectives. That said, you could alternatively use です, which also can mark nouns and な-adjectives instead of using な.

> 
> 
> [二十歳です]**ので**[お酒が飲めます]。
> 
> [このシャツはきれいです]**ので**[洗濯する必要はありません]。
> 
> 
...
中途終了型発話文「〜けど」「〜ので」の要求・断り行為場面における待遇的談話機能

by 楠本 徹也
(2015)

<!-- quiz: {"type":"multiple-choice","question":"What does \"お腹が空いたのでレストランに行きました。\" mean?","options":["I got hungry so I went to a restaurant.","[I got hungry] so [I went to a restaurant].","[I'm twenty years old] so [I can drink alcohol].","[This shirt is clean] so [there's no need to wash it]."],"answer":0} -->

<!-- quiz: {"type":"multiple-choice","question":"What does \"[お腹が空いた]**ので**[レストランに行きました]。\" mean?","options":["[I got hungry] so [I went to a restaurant].","I got hungry so I went to a restaurant.","[I'm twenty years old] so [I can drink alcohol].","[This shirt is clean] so [there's no need to wash it]."],"answer":0} -->

<!-- quiz: {"type":"multiple-choice","question":"What does \"[二十歳]**なので**[お酒が飲めます]。\" mean?","options":["[I'm twenty years old] so [I can drink alcohol].","I got hungry so I went to a restaurant.","[I got hungry] so [I went to a restaurant].","[This shirt is clean] so [there's no need to wash it]."],"answer":0} -->
