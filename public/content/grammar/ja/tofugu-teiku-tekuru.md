# ていく / てくる — Coming & Going

> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/teiku-tekuru/). For personal study.

〜ていく・〜てくる for Gradual Process
- 
...
So, let's say you've just made a resolution to get into the habit of learning ten new Japanese words a day. Since you hope to continue the practice from now on, you can use 〜ていく and say:
  ...
  - これから毎日、新しい日本語の単語を１０個覚え**ていく**つもりです。
...
First let's go back to the scenario where you are an exercise instructor finishing up a light stretch. To tell your students it's going to get a little more difficult, you can use either 〜ていく or 〜てくる and say:
  ...
  - ここからは、ちょっと難しくなっ [**ていき**ます・**てき**ます] よ。
...
<!-- quiz: {"type":"multiple-choice","question":"What does \"ガチョウの 群(む)れが飛んで行った。\" mean?","options":["A gaggle of geese flew away.","A gaggle of geese flew in.","From now on, I'm going to learn ten new Japanese words every day.","Let's start by doing some light stretching."],"answer":0} -->

<!-- quiz: {"type":"multiple-choice","question":"What does \"ガチョウの群れが飛んで来た。\" mean?","options":["A gaggle of geese flew in.","A gaggle of geese flew away.","From now on, I'm going to learn ten new Japanese words every day.","Let's start by doing some light stretching."],"answer":0} -->

<!-- quiz: {"type":"multiple-choice","question":"What does \"これから毎日、新しい日本語の単語を１０個覚え**ていく**つもりです。\" mean?","options":["From now on, I'm going to learn ten new Japanese words every day.","A gaggle of geese flew away.","A gaggle of geese flew in.","Let's start by doing some light stretching."],"answer":0} -->
