...
> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/conditional-form-nara/). For personal study.
...
なら can be used with nouns, い-adjectives, な-adjectives, and verbs. To make sentences, put なら after the dictionary form of these words.
...
<!-- quiz: {"type":"multiple-choice","question":"What does \"寒いならこれを着てください。\" mean?","options":["Please put this on if you are cold.","If you are happy, I'm happy too.","Let's go see cherry blossoms if spring comes.","If you meet with Koichi, please tell him to check his email."],"answer":0} -->

<!-- quiz: {"type":"multiple-choice","question":"What does \"あなたが嬉しいなら、私も嬉しいです。\" mean?","options":["If you are happy, I'm happy too.","Please put this on if you are cold.","Let's go see cherry blossoms if spring comes.","If you meet with Koichi, please tell him to check his email."],"answer":0} -->

<!-- quiz: {"type":"multiple-choice","question":"What does \"❌ 春になるなら、お花見をしましょう。\" mean?","options":["Let's go see cherry blossoms if spring comes.","Please put this on if you are cold.","If you are happy, I'm happy too.","If you meet with Koichi, please tell him to check his email."],"answer":0} -->
