...
> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/mou-little-more/). For personal study.
...
Notice the above examples described the extra bottle of beer as もう一**本** and a few more *karaage* as もう二、三**個**?
...
If you say "to be drowned" in English, for example, it usually indicates the tragic outcome of submersion in and the inhalation of water. The Japanese counterpart  溺(おぼ)れる, on the other hand, denotes a struggle in the water and does not necessarily imply a sad outcome.
...
<!-- quiz: {"type":"multiple-choice","question":"What does \"一つ買おう。\" mean?","options":["l should buy one.","l should buy **one more**.","Could you say that **one more time**?","Could you say that **a little louder**?"],"answer":0} -->

<!-- quiz: {"type":"multiple-choice","question":"What does \"**もう一つ**買おう。\" mean?","options":["l should buy **one more**.","l should buy one.","Could you say that **one more time**?","Could you say that **a little louder**?"],"answer":0} -->

<!-- quiz: {"type":"multiple-choice","question":"What does \"**もう一回**言ってもらえませんか？\" mean?","options":["Could you say that **one more time**?","l should buy one.","l should buy **one more**.","Could you say that **a little louder**?"],"answer":0} -->

## Sources

- [Tofugu](https://www.tofugu.com/japanese-grammar/mou-little-more/)
