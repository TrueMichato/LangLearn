...
> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/i-adjective-conditional-form-kereba/). For personal study.

Japanese い-Adjective Conditional Form ければ
- 
...
> 
> 
> positive (cute):　　　かわい**い**　+　ければ　→　かわい**ければ**　(if cute)
> 
> negative (not cute):　かわいくな**い**　+　ければ　→　かわいくな**ければ**　(if not cute)
> 
> 
...
The noun form of some verbs look like い-adjectives. For example, 違**う** (to be different/incorrect) becomes 違**い**(difference/error) in its noun form. Since 違い looks like an い-adjective, you might be tempted to use 〜ければ when you want to make it conditional. However, since 違う a verb, it requires a different way of forming the conditional.
...
<!-- quiz: {"type":"multiple-choice","question":"What does \"おいし**ければ**、売れるでしょう。\" mean?","options":["If it's delicious, it will sell well.","I think it will sell well… if it’s delicious, that is.","All's well that ends well.","I go for a run outside every day, if the weather's nice."],"answer":0} -->
