...
> **Source:** Content from [Tofugu](https://www.tofugu.com/japanese-grammar/conjunctive-particle-ga-kedo/). For personal study.

Conjunctive Particles が・けど: "But" in Japanese
- 
...
Conjunctive particles が and けど are often used in a similar way to the English word "but." Additionally, they can be used to link context to whatever comes next.

## The Basics

Conjunctive particles が and けど are similar to "but" in English — they connect two contrasting sentences.

  - 白ワインは好きです**が**、赤ワインはあまり好きではないです。
...
For example, you're at a convenience store with your boss during a break. You realize that you left your wallet at the office and want to borrow some money from him. In this case, you might say something like:
  ...
  - 財布を忘れてしまったんです**が**、５００円貸してもらえませんか？
...
Like I mentioned earlier, there are more effects that が and けど can create. To explore more, check out Kanae's article Kedo: Why Do Japanese People End Sentences with "But"…?
...
<!-- quiz: {"type":"multiple-choice","question":"What does \"白ワインは好きです**が**、赤ワインはあまり好きではないです。\" mean?","options":["I like white wine **but** I am not a big fan of red wine.","I don't have a pen with me. Can you lend me one?","My mother came to the concert, **but** my older sister didn't.","It's raining, **but** the children are playing outside."],"answer":0} -->
