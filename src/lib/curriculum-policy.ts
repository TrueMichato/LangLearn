...
> = {
  'msa-vs-dialects': 'shared',
  'egyptian-basics': ['egyptian'],
  'levantine-basics': ['levantine'],
  'gulf-basics': ['gulf'],
  'everyday-phrases': 'shared',
  'maghrebi-basics': ['maghrebi'],
  'dialect-pronouns-verbs': 'shared',
  'dialect-negation': 'shared',
  'dialect-future-continuous': 'shared',
  'arabizi-chat': 'shared',
  'dialect-comparison': 'shared',
  'dialect-object-pronouns': 'shared',
  'dialect-question-words': 'shared',
  'dialect-verb-conjugation': 'shared',
