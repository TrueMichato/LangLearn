...
export const immersionTips: ImmersionTip[] = [
  ...
  {
    id: 'ar-aljazeera',
    title: 'Read & watch Al Jazeera',
    description: 'Al Jazeera (aljazeera.net) is clear Modern Standard Arabic. Start with headlines and short clips — the same MSA you study is used across all Arab news.',
    icon: '📰',
    category: 'media',
    languages: ['ar'],
  },
  {
    id: 'ar-egyptian-cinema',
    title: 'Watch Egyptian films & series',
    description: 'Egyptian film and TV are understood across the Arab world — the easiest gateway into a spoken dialect. Add Arabic subtitles to connect sound and script.',
    icon: '🎬',
    category: 'media',
    languages: ['ar'],
  },
  {
    id: 'ar-music-radio',
    title: 'Put on Arabic music & radio',
    description: 'Stream Arabic radio or classics by Fairuz, Umm Kulthum and Abdel Halim. Look up the lyrics and let the melodies fix vocabulary and rhythm in your ear.',
    icon: '🎵',
    category: 'media',
    languages: ['ar'],
  },
  {
    id: 'ar-kids-content',
    title: 'Start with children\u2019s content',
    description: 'Cartoons and children\u2019s shows in Fuṣḥā (e.g. dubbed classics on YouTube) use slow, clear MSA with simple vocabulary — perfect early listening practice.',
    icon: '🧸',
    category: 'media',
    languages: ['ar'],
  },
  {
    id: 'ar-calligraphy',
    title: 'Practise the script by hand',
    description: 'Copying Arabic by hand — even simple words or a line of calligraphy — cements the letter forms and how they join far faster than reading alone.',
    icon: '🖋️',
    category: 'creative',
    languages: ['ar'],
  },
  {
    id: 'ar-language-exchange',
    title: 'Find a dialect partner',
    description: 'Choose one dialect and find a speaker to chat with. Learners often study MSA but speak a dialect daily — a partner bridges the "book Arabic" gap fast.',
    icon: '🗣️',
    category: 'social',
    languages: ['ar'],
  },
