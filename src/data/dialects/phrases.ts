...
export const DIALECT_PHRASES: DialectPhrase[] = [
  ...
  },
  {
    en: 'Good morning',
    forms: {
      msa: { ar: 'صَباحُ الخَيْر', tr: 'ṣabāḥu l-khayr' },
      egyptian: { ar: 'صَباح الخير', tr: 'ṣabāḥ el-khēr' },
      levantine: { ar: 'صَباح الخير', tr: 'ṣabāḥ el-khēr' },
      gulf: { ar: 'صَباح الخير', tr: 'ṣabāḥ al-khēr' },
      iraqi: { ar: 'صَباح الخير', tr: 'ṣabāḥ el-khēr' },
      maghrebi: { ar: 'صْباح الخير', tr: 'ṣbāḥ el-khīr' },
    },
  },
  {
    en: 'Please (to a man)',
    forms: {
      msa: { ar: 'مِنْ فَضْلِكَ', tr: 'min faḍlik' },
      egyptian: { ar: 'لو سَمَحْت', tr: 'law samaḥt' },
      levantine: { ar: 'لو سَمَحْت', tr: 'law samaḥt' },
      gulf: { ar: 'لو سَمَحْت', tr: 'law samaḥt' },
      iraqi: { ar: 'لو سَمَحِت', tr: 'law samaḥit' },
      maghrebi: { ar: 'عافاك', tr: 'ʿafāk' },
    },
  },
  {
    en: "Sorry / I'm sorry",
    forms: {
      msa: { ar: 'آسِف', tr: 'āsif' },
      egyptian: { ar: 'آسِف', tr: 'āsif' },
      levantine: { ar: 'آسِف', tr: 'āsif' },
      gulf: { ar: 'آسِف', tr: 'āsif' },
      iraqi: { ar: 'آسِف', tr: 'āsif' },
      maghrebi: { ar: 'سْمَح لِيَّ', tr: 'smaḥ liyya' },
    },
  },
  {
    en: "I don't know",
    forms: {
      msa: { ar: 'لا أَعْرِف', tr: 'lā aʿrif' },
      egyptian: { ar: 'مَعْرَفْش', tr: 'maʿrafsh' },
      levantine: { ar: 'ما بَعْرِف', tr: 'mā baʿref' },
      gulf: { ar: 'ما أَدْري', tr: 'mā adri' },
      iraqi: { ar: 'ما أَعْرُف', tr: 'mā aʿruf' },
      maghrebi: { ar: 'ما نْعَرَفْش', tr: 'ma-nʿarafsh' },
    },
  },
  {
    en: "I don't understand",
    forms: {
      msa: { ar: 'لا أَفْهَم', tr: 'lā afham' },
      egyptian: { ar: 'مِش فاهِم', tr: 'mish fāhim' },
      levantine: { ar: 'مِش فاهِم', tr: 'mish fāhim' },
      gulf: { ar: 'ما فْهِمْت', tr: 'mā fhimt' },
      iraqi: { ar: 'ما فْهَمِت', tr: 'mā fhamit' },
      maghrebi: { ar: 'ما فْهَمْتْش', tr: 'ma-fhemtsh' },
    },
  },
  {
    en: 'Water',
    forms: {
      msa: { ar: 'ماء', tr: 'māʾ' },
      egyptian: { ar: 'مَيَّة', tr: 'mayya' },
      levantine: { ar: 'مَيّ', tr: 'mayy' },
      gulf: { ar: 'ماي', tr: 'māy' },
      iraqi: { ar: 'ماي', tr: 'māy' },
      maghrebi: { ar: 'الما', tr: 'l-ma' },
    },
  },
  {
    en: 'Money',
    forms: {
      msa: { ar: 'نُقود', tr: 'nuqūd' },
      egyptian: { ar: 'فُلوس', tr: 'fulūs' },
      levantine: { ar: 'مَصاري', tr: 'maṣāri' },
      gulf: { ar: 'فْلوس', tr: 'flūs' },
      iraqi: { ar: 'فْلوس', tr: 'flūs' },
      maghrebi: { ar: 'فْلوس', tr: 'flūs' },
    },
  },
  {
    en: 'A lot / very',
    forms: {
      msa: { ar: 'كَثيرًا', tr: 'kathīran' },
      egyptian: { ar: 'كِتير', tr: 'kitīr' },
      levantine: { ar: 'كْتير', tr: 'ktīr' },
      gulf: { ar: 'وايِد', tr: 'wājid' },
      iraqi: { ar: 'هْواي', tr: 'hwāya' },
      maghrebi: { ar: 'بَزّاف', tr: 'bezzāf' },
    },
  },
  {
    en: 'Come here (to a man)',
    forms: {
      msa: { ar: 'تَعالَ هُنا', tr: 'taʿāla hunā' },
      egyptian: { ar: 'تَعالى هِنا', tr: 'taʿāla hena' },
      levantine: { ar: 'تَعا لَهون', tr: 'taʿa la-hōn' },
      gulf: { ar: 'تَعالْ هِني', tr: 'taʿāl hini' },
      iraqi: { ar: 'تَعالْ لِهْنا', tr: 'taʿāl li-hnā' },
      maghrebi: { ar: 'أَجي لْهْنا', tr: 'āji l-hna' },
    },
  },
  {
    en: 'What time is it?',
    forms: {
      msa: { ar: 'كَمِ السّاعة؟', tr: 'kam is-sāʿa?' },
      egyptian: { ar: 'السّاعة كامْ؟', tr: 'is-sāʿa kām?' },
      levantine: { ar: 'أَدّيش السّاعة؟', tr: 'ʾaddēsh is-sāʿa?' },
      gulf: { ar: 'كَمِ السّاعة؟', tr: 'kam is-sāʿa?' },
      iraqi: { ar: 'السّاعة بيش؟', tr: 'is-sāʿa beesh?' },
      maghrebi: { ar: 'شْحال فْالسّاعة؟', tr: 'shḥāl f-sāʿa?' },
    },
  },
];
