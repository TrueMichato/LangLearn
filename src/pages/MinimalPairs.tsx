...
import { jaMinimalPairs, ruMinimalPairs, ptMinimalPairs, esMinimalPairs, arMinimalPairs } from '../data/minimal-pairs';
...
const CATEGORIES: Record<string, string> = {
  ...
  // PT
  'open-closed': 'Open vs Closed Vowels (á/â, ó/ô)',
  sibilant: 'S/Z Sounds (ç, s, ss)',
  'r-sounds': 'R Sounds (r vs rr)',
  palatal: 'Palatal Consonants (lh, nh)',
  consonant: 'Consonant Contrasts',
  // ES
  rolled: 'Rolled R (r vs rr)',
  yeismo: 'LL/Y Pronunciation',
  'b-v': 'B vs V',
  'c-z-s': 'C / Z / S Sibilants',
  'n-ñ': 'N vs Ñ',
  'accent-stress': 'Accent & Stress',
  // AR
  emphatic: 'Emphatic vs Plain (ص/س، ط/ت، ض/د، ظ/ذ)',
  throat: 'Throat Letters (ح/ه، ع/ء)',
  similar: 'Similar Consonants (ق/ك، خ/غ)',
};
